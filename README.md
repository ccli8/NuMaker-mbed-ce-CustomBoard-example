...
1.  Clone the example and navigate into it
    ```
    $ git clone https://github.com/OpenNuvotonMbed/NuMaker-mbed-ce-CustomBoard-example
...
1.  Flash by drag-n-drop built image `<app>.bin` or `<app>.hex` onto **NuMaker-M483KG** board
